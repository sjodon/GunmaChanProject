...
public class MountainBackgroundDrawer {
    ...
    public MountainBackgroundDrawer(SpriteBatch batch, int screen_bottom_adjust, GameAssets gameAssets) {
        this.batch = batch;
        ...
        this.mountain = new Texture(gameAssets.getMountainWithPath());
