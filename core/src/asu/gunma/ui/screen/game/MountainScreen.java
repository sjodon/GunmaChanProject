...
import asu.gunma.ui.screen.menu.OptionMenu;
...
public class MountainScreen implements Screen {
    ...
    public MountainScreen(Game game, ActionResolver speechGDX, Music music, DbInterface dbCallback, ArrayList<VocabWord> activeList, Preferences prefs, GameAssets gameAssets) {
        this.game = game;
        this.prefs = prefs;
