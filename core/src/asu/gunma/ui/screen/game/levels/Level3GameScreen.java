...
public class Level3GameScreen implements Screen {
    ...
    public Level3GameScreen(Game game, ActionResolver speechGDX, Music music, DbInterface dbCallback, Screen previous, ArrayList<VocabWord> activeList, Preferences prefs, GameAssets gameAssets) {
        this.game = game;
        this.prefs = prefs;
    ...
    public void show() {
        ...
        this.onionWalkAnimation = new Animator(gameAssets.placeholderFrenemyAnimation2Path, 4, 2, 0.1f);
    ...
    public void render(float delta) {
        ...
        if (!isGameOver) {
          ...
          /*  if (score >= 0){
            ...
            gameAssets.saveUserScore(score, gameAssets.userNickname, 3);
            game.setScreen(new ScoreScreen(game, speechGDX,  gameMusic, dbCallback,previousScreen, activeVList, prefs, gameAssets, score, numStars, 3));
            dispose(); // dispose of current GameScreen
        }
